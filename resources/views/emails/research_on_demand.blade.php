...
<head>
  ...
  <![endif]-->
  <title>Research on demand</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">¡Bienvenido a la comunidad SmartAgro!</div>
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-size: 16px; line-height: 24px; color: #626262;">
                      <p>Se ha recibido una nueva solicitud correspondiente a research on demand. Los datos completados en el formulario son:</p>
                      ...
                      <p><strong>Tipo de Estudio:</strong> {{ $data['study_type'] }}</p>
                      <p><strong>Cantidad de Casos:</strong> {{ $data['cases_count'] }}</p>
                      <p><strong>Rango de Inversión:</strong> {{ $data['investment_range'] }}</p>
