...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Se recibio una solicitud para restablecer la contraseña de su cuenta SmartAgro</div>
                    ...
                    <tr>
                      <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                        ...
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                          Se recibio una solicitud para restablecer la contraseña de su cuenta SmartAgro.
                        </p>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 12px;"><b>1.</b> Ingresá a la plataforma:</p>
                        <a href="https://app.smartagro.io/" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 24px; display: block; font-size: 16px; line-height: 100%; color: #16A860; text-decoration: none;"><b>https://app.smartagro.io/</b></a>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 12px;"><b>2.</b> Copia e ingresá esta nueva contraseña para poder volver a loguear:</p>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 12px;"><b>{{ $str_random_password }}</b></p>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 36px;"><b>3.</b> Te recomendamos ir a tu perfil, luego a la sección “Seguridad”, y cambiarla por una contraseña de tu elección.</p>
                        ...
                        <table cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #16A860; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                              <a href="https://app.smartagro.io" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Modificar contraseña &rarr;</a>
                            </td>
                          </tr>
                        </table>
